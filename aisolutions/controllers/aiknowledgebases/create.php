<?php Block::put('breadcrumb') ?>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= Backend::url('marty/aisolutions/aiknowledgebases') ?>">Ai Knowledge Base</a></li>
        ...
        <div class="form-buttons">
            <div data-control="loader-container">
                ...
                <span class="btn-text">
                    ...
                    <a
                        href="<?= Backend::url('marty/aisolutions/aiknowledgebases') ?>"
